...
function MenuNavigator() {
  ...
  return (
    <View style={{backgroundColor: '#3E00C0', height: 100, marginLeft: 35, marginRight: 35, marginTop: -55, borderRadius: 15, justifyContent: 'center', padding: 20, shadowColor: '#000',
    shadowOffset: {
      width: 0,
      height: 7,
    },
